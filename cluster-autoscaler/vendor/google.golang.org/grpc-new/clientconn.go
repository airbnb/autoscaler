...
import (
	...
	"google.golang.org/grpc-new/balancer"
	"google.golang.org/grpc-new/balancer/base"
	"google.golang.org/grpc-new/codes"
	"google.golang.org/grpc-new/connectivity"
	"google.golang.org/grpc-new/credentials"
	"google.golang.org/grpc-new/internal/backoff"
	"google.golang.org/grpc-new/internal/channelz"
	"google.golang.org/grpc-new/internal/grpcsync"
	"google.golang.org/grpc-new/internal/grpcutil"
	iresolver "google.golang.org/grpc-new/internal/resolver"
	"google.golang.org/grpc-new/internal/transport"
	"google.golang.org/grpc-new/keepalive"
	"google.golang.org/grpc-new/resolver"
	"google.golang.org/grpc-new/serviceconfig"
	"google.golang.org/grpc-new/status"

	_ "google.golang.org/grpc-new/balancer/roundrobin"           // To register roundrobin.
	_ "google.golang.org/grpc-new/internal/resolver/dns"         // To register dns resolver.
	_ "google.golang.org/grpc-new/internal/resolver/passthrough" // To register passthrough resolver.
	_ "google.golang.org/grpc-new/internal/resolver/unix"        // To register unix resolver.
)
