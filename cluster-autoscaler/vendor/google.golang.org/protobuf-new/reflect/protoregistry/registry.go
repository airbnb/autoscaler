...
//	go build -ldflags "-X google.golang.org/protobuf-new/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "google.golang.org/protobuf-new/types/known/" + pkgName
	panic(fmt.Sprintf(""+
